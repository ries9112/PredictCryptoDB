...
# this better but takes longer: 
#query <- "select * from CoinCheckupDetails where Rank > 0 order by pkDummy desc, rank asc limit 5"
...
# this better but takes longer: 
#query <- "select * from CoinStatsPrices where Rank > 0 order by pkDummy desc, rank asc limit 5"
...
# this better but takes longer: 
#query <- "select * from CoinToBuy where Rank > 0 order by pkDummy desc, rank asc limit 5"
...
# this better but takes longer: 
#query <- "select * from ScrapeStorm.Messari where Rank > 0 order by pkDummy desc, rank asc limit 5"
...
#### [**`BitgurBackup`**](https://predictcryptodb.com/question/16)
```{r BitgurBackupBTCPreview, echo=F}
query <- "SELECT * FROM ScrapeStorm.Bitgur limit 5"
# this better but takes longer: 
#query <- "select * from ScrapeStorm.Bitgur order by pkDummy desc limit 5"
...
- Documentation: [predictcryptodb.com/reference/databases/4/tables/576](https://predictcryptodb.com/reference/databases/4/tables/576)
